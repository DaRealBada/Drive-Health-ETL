...
function shouldSample(idempotencyKey, auditRate) {
  ...
  // Convert first 8 chars to integer and normalize to 0-1 by dividing the integer by largest possible 8-char hexadecimal.
...
function processPayload(payload, eventType) {
  // spread syntax ('...') used to create a copy of payload object
