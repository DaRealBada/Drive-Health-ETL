...
app.post('/process-call', async (req, res) => {
  try {
    ...
    // Takes the encoded message.data and tells Node.js, "This is a base64 container". Then, it opens and converts container into a regular JSON string. We then take this and parse it into a structured Javascript Object
