...
app.post('/process-call', async (req, res) => {
  ...
  const subscriptionName = 'call-audits-pull-subscription'; // <-- IMPORTANT: Use your PULL subscription name
  const pullRequest = {
  ...
  try {
    ...
    const [response] = await pubSubClient.subscription(subscriptionName).pull(pullRequest);
