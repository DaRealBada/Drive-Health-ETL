...
// Create the Express app; Create the BigQuery client instance;
const app = express();
// Create the BigQuery client instance
const bigquery = new BigQuery();
// Configure PORT from environment variables or default to 8080
...
// Add BigQuery dataset and table configuration
