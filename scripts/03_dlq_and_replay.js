...
class DLQReplayTest {
  ...
  async run() {
    ...
    console.log('   - Now, check your Cloud Monitoring dashboard. You should see a brief 4xx spike and a non-zero DLQ backlog.');
    ...
    console.log('   - After the replay job, the message should have been successfully processed and written to BigQuery.');
